// Mock leads for demo/test mode - Location-specific examples
const mockLeads = [
  // ========== AUSTIN LEADS ==========
  {
    // Lead 1: High Intent - Burned-out Airbnb host in Austin
    ...
    suggestedOutreach: "Hi Marcus! I understand the STR burnout - managing 4 properties solo is overwhelming. I specialize in Austin Airbnbs and can take over immediately. Let's talk today?",
    riskFlags: [],
    nextSteps: ["Send DM immediately", "Offer same-day consultation"],
    facebookPostUrl: "https://facebook.com/groups/austin-property/posts/947382"
  },
  {
    // Lead 2: Moderate Interest - Austin investor considering STR to LTR switch
    ...
    suggestedOutreach: "Hi Sarah! Many Austin STR owners are making the switch. A good PM can handle the transition and typically pays for itself through better tenant screening and retention. Let's discuss Austin-specific strategies?",
    riskFlags: ["price_sensitive"],
    nextSteps: ["Share STR to LTR transition guide", "Offer fee structure comparison"],
    facebookPostUrl: "https://facebook.com/groups/austin-investors/posts/558291"
  },
  {
    // Lead 3: Low Intent - New Austin landlord asking basic questions
    ...
    suggestedOutreach: "Welcome to landlording, Jessica! Since you live on-site, self-managing one unit is definitely doable. Happy to share Austin landlord resources and tips for getting started!",
    ...
    facebookPostUrl: "https://facebook.com/groups/austin-property/posts/773625"
  },
  {
    // Lead 4: High Intent - Remote Austin owner
    ...
    suggestedOutreach: "Hi Robert! Managing Austin properties from California is challenging. I work with several remote owners and provide detailed monthly reports so you stay in control. Let's chat before your move?",
    riskFlags: ["control_concerns"],
    nextSteps: ["Schedule call before move", "Emphasize communication and transparency"],
    facebookPostUrl: "https://facebook.com/groups/austin-rentals/posts/885743"
  },

  // ========== DENVER LEADS ==========
  {
    // Lead 1: High Intent - Overwhelmed Denver STR owner
    ...
    suggestedOutreach: "Hi Rachel! I specialize in Denver STR compliance and can get your properties up to code immediately. I know the licensing process inside out. Let's fix this today before any penalties!",
    riskFlags: ["compliance_issues"],
    nextSteps: ["Emergency consultation today", "STR compliance audit"],
    facebookPostUrl: "https://facebook.com/groups/denver-str/posts/445892"
  },
  {
    // Lead 2: Moderate Interest - Denver mountain property owner
    ...
    suggestedOutreach: "Hi Michael! Managing mountain properties remotely is especially tough. Many Denver investors find PMs actually increase profits through better maintenance coordination and occupancy. Let's review your portfolio?",
    riskFlags: ["price_shopping", "long_term_diy"],
    nextSteps: ["Portfolio analysis", "Mountain property management pitch"],
    facebookPostUrl: "https://facebook.com/groups/denver-investors/posts/772341"
  },
  {
    // Lead 3: Low Intent - Inherited Denver property
    ...
    suggestedOutreach: "Hi Amy! Park Hill is a great rental market. Happy to share info on Denver's rental license process and what renovations typically yield the best ROI. Many inherited property owners find PMs helpful for navigating regulations.",
    riskFlags: ["may_sell", "needs_renovation", "early_stage"],
    nextSteps: ["Rental vs sale analysis", "Licensing education"],
    facebookPostUrl: "https://facebook.com/groups/denver-property/posts/339281"
  },
  {
    // Lead 4: High Intent - Scaling Denver investor
    ...
    suggestedOutreach: "Hi Carlos! Congrats on the Five Points deal! I partner with several Denver investors on portfolio growth - from acquisition analysis to maximizing NOI. Let's discuss how PM can accelerate your scaling goals.",
    riskFlags: [],
    nextSteps: ["Growth strategy session", "Portfolio takeover plan"],
    facebookPostUrl: "https://facebook.com/groups/colorado-rein/posts/667234"
  },

  // ========== MIAMI LEADS ==========
  {
    // Lead 1: High Intent - Miami Beach condo crisis
    ...
    suggestedOutreach: "Hi David! I can take over your properties today and handle the incoming guests. I'm familiar with Miami Beach condo rules and have Spanish-speaking staff. Let's connect ASAP to save these bookings!",
    riskFlags: ["emergency_situation"],
    nextSteps: ["Immediate phone call", "Emergency takeover protocol"],
    facebookPostUrl: "https://facebook.com/groups/miamibeach-condos/posts/998123"
  },
  {
    // Lead 2: Moderate Interest - Brickell investor tired of traffic
    ...
    suggestedOutreach: "Hi Jennifer! Miami traffic is brutal for property management. Our team handles all maintenance calls so you never have to drive to properties. Most clients find we save them 20+ hours/month. Let's talk ROI?",
    riskFlags: ["price_sensitive", "profit_focused"],
    nextSteps: ["Time & cost savings analysis", "Local team emphasis"],
    facebookPostUrl: "https://facebook.com/groups/miami-investors/posts/445672"
  },
  {
    // Lead 3: Low Intent - Snowbird considering rental
    ...
    suggestedOutreach: "Hi Patricia! Many snowbirds successfully rent May-October in Miami. PMs handle seasonal rentals and provide hurricane preparation/monitoring. Happy to explain how we protect properties during storm season!",
    ...
    facebookPostUrl: "https://facebook.com/groups/miami-property/posts/776234"
  },
  {
    // Lead 4: High Intent - International investor
    ...
    suggestedOutreach: "Hi Eduardo! I work with many Brazilian investors and understand the importance of clear communication and detailed reporting. We provide monthly reports in Portuguese if needed. Let's discuss a smooth transition from your current PM.",
    riskFlags: ["bad_pm_experience"],
    nextSteps: ["Bilingual communication emphasis", "PM transition plan"],
    facebookPostUrl: "https://facebook.com/groups/intl-miami-investors/posts/234561"
  }
];
